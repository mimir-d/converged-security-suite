...
func KMStructureValidKMPubHashAlg() (bool, error) {
	if objUnderTest.km.PubKeyHashAlg != manifest.AlgSHA256 && objUnderTest.km.PubKeyHashAlg != manifest.AlgSHA384 && objUnderTest.km.PubKeyHashAlg != manifest.AlgSM3_256 {
...
func KMStructureValidSigHashAlg() (bool, error) {
	...
	case *sm2.PublicKey:
		if objUnderTest.km.KeyAndSignature.Signature.HashAlg != manifest.AlgSM3_256 {
